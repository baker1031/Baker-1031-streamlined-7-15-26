---
url: https://baker1031.com/our-approach.html
slug: our-approach
title: "Our Approach"
category: detail
words: 1083
...
Our Approach | Baker 1031 Investments
...
Stewardship
Back to About
By Jerry Baker · Reviewed by a registered principal · Updated June 2026
...
❯ Debt to replace — the mortgage paid off at sale. You generally must replace that debt (or add equivalent cash) to avoid taxable &ldquo;boot.&rdquo;
...
There is no single &ldquo;right&rdquo; number, but the decision is driven by competing forces: diversification pushes the count up; investment minimums ($25,000&ndash;$100,000) push it down; the 45-day identification rules shape the list; and each position is a separate K-1 and full-cycle event to track.
...
Once the position count is set, we diversify deliberately across several independent axes — not just &ldquo;different buildings,&rdquo; but different sources of risk:
Sponsor Spreading across managers so no single operator dominates the portfolio.
Sector Balancing income-oriented sectors (net-lease, medical) with growth-oriented ones (multifamily, industrial).
Geography Avoiding concentration in a single market or region.
Leverage Matching the debt you need to replace, and blending leveraged with debt-free positions.
Business Plan Core/stabilized income vs. value-add, and the role each plays.
Vintage & Hold Staggering expected hold periods so full-cycle events do not all arrive at once.
Step 4
...
$1.2M equity · ~$480k debt to replace (&asymp;40% leverage). 5 positions, 5 sponsors; blended leverage tuned to the debt to be replaced.
...
$3.0M equity · step-up focus · optionality valued. 7&ndash;8 positions, 6+ sponsors; staggered holds; a 721-eligible sleeve preserves a path to REIT units.
...
$250,000 equity · mindful of minimums. 2&ndash;3 positions; diversification constrained by $25k&ndash;$100k minimums.
Step 6
...
Reviewed by Lori Kamen — Chief Compliance Officer, Aurora Securities, Inc. (FINRA CRD #2805591). Last reviewed July 12, 2026. Securities offered through Aurora Securities, member FINRA/SIPC.
