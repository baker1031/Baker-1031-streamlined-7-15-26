---
url: https://baker1031.com/sponsor-passco.html
slug: sponsor-passco
title: "Passco"
category: sponsor
words: 669
...
Passco | Baker 1031 Investments
Home ❯ Sponsors ❯ Passco
Passco
On This Page
Sponsor Facts
Overview
...
This page is a Baker 1031 Investments research summary for Passco. The workbook currently records a reported founding year of 1998, reported assets under management of $4.1B, a reported headquarters in Irvine, CA. Baker 1031 presents these fields to help an accredited investor organize due-diligence questions; the page is not a sponsor endorsement, performance guarantee, or individualized investment recommendation.
...
What the strategy fields mean The strategy and advantage fields are a compact description of how Passco presents its approach. They are not a recommendation, rating, or substitute for the PPM. Compare them with property-level leverage, tenant concentration, reserves, fees, exit assumptions, and the investor rights described in the offering documents. Founder Bill Passo helped pioneer the modern TIC 1031 structure (Rev. Proc. 2002-22). Concentrates on Class A multifamily in Southeastern and secondary/tertiary markets. Has completed $8B+ in acquisitions across multiple cycles. Owns or manages roughly 30,000 units. Manages $4.1 billion, a seasoned large-scale presence.
Current coverage
3 current offerings are linked from this profile. Availability, projected income, leverage, and documents can change, so investors should confirm the current version of each PPM and related supplement before relying on any figure. The page includes 46 full-cycle records in the current workbook. Those figures are sponsor-reported and unaudited; they are shown to make the source and scope visible, not to imply that a future offering will repeat historical results.
