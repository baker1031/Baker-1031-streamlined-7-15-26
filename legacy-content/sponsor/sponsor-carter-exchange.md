---
url: https://baker1031.com/sponsor-carter-exchange.html
slug: sponsor-carter-exchange
title: "Carter Exchange"
category: sponsor
words: 666
---

Carter Exchange | Baker 1031 Investments
Home ❯ Sponsors ❯ Carter Exchange
Carter Exchange
On This Page
Sponsor Facts
Overview
...
This page is a Baker 1031 Investments research summary for Carter Exchange. The workbook currently records a reported founding year of 2017, reported assets under management of $3.0B, a reported headquarters in Tampa, FL. Baker 1031 presents these fields to help an accredited investor organize due-diligence questions; the page is not a sponsor endorsement, performance guarantee, or individualized investment recommendation.
...
What the strategy fields mean The strategy and advantage fields are a compact description of how Carter Exchange presents its approach. They are not a recommendation, rating, or substitute for the PPM. Compare them with property-level leverage, tenant concentration, reserves, fees, exit assumptions, and the investor rights described in the offering documents. Specializes in data centers/mission-critical infrastructure through its Aphorio Carter arm. Operates a Class A multifamily DST platform alongside its infrastructure focus. Draws leadership from the Carter Validus mission-critical REITs ($50B+ cumulative CRE volume). Runs captive property management across the Carter Funds family. Manages roughly $3 billion across affiliated companies.
Current coverage
No current offerings are linked from this profile in the workbook snapshot. The directory can change as new offerings are reviewed. The page includes 3 full-cycle records in the current workbook. Those figures are sponsor-reported and unaudited; they are shown to make the source and scope visible, not to imply that a future offering will repeat historical results.
