---
url: https://baker1031.com/sponsor-time-equities.html
slug: sponsor-time-equities
title: "Time Equities"
category: sponsor
words: 664
---

Time Equities | Baker 1031 Investments
Home ❯ Sponsors ❯ Time Equities
Time Equities
On This Page
Sponsor Facts
Overview
...
This page is a Baker 1031 Investments research summary for Time Equities. The workbook currently records a reported founding year of 1966, reported assets under management of $5.4B, a reported headquarters in New York, NY. Baker 1031 presents these fields to help an accredited investor organize due-diligence questions; the page is not a sponsor endorsement, performance guarantee, or individualized investment recommendation.
...
What the strategy fields mean The strategy and advantage fields are a compact description of how Time Equities presents its approach. They are not a recommendation, rating, or substitute for the PPM. Compare them with property-level leverage, tenant concentration, reserves, fees, exit assumptions, and the investor rights described in the offering documents. Pioneered cooperative and condominium conversions (10,000+ units historically). Develops large mixed-use towers such as 50 West Street and Chicago&#x27;s 1000M. Diversified across 33 states and international markets. Holds 5,000+ multifamily units within a $5.4B+, 36M-sq-ft portfolio. Pursues a patient long-hold value orientation under founder Francis Greenburger.
Current coverage
No current offerings are linked from this profile in the workbook snapshot. The directory can change as new offerings are reviewed. The page includes 20 full-cycle records in the current workbook. Those figures are sponsor-reported and unaudited; they are shown to make the source and scope visible, not to imply that a future offering will repeat historical results.
