---
url: https://baker1031.com/sponsor-bluerock.html
slug: sponsor-bluerock
title: "Bluerock"
category: sponsor
words: 685
---

Bluerock | Baker 1031 Investments
Home ❯ Sponsors ❯ Bluerock
Bluerock
On This Page
Sponsor Facts
Overview
...
This page is a Baker 1031 Investments research summary for Bluerock. The workbook currently records a reported founding year of 2002, reported assets under management of $19.0B, a reported headquarters in New York, NY. Baker 1031 presents these fields to help an accredited investor organize due-diligence questions; the page is not a sponsor endorsement, performance guarantee, or individualized investment recommendation.
...
What the strategy fields mean The strategy and advantage fields are a compact description of how Bluerock presents its approach. They are not a recommendation, rating, or substitute for the PPM. Compare them with property-level leverage, tenant concentration, reserves, fees, exit assumptions, and the investor rights described in the offering documents. Has sponsored syndicated 1031 exchanges for more than 18 years, one of the longer continuous DST records. Packages multifamily and industrial as trademarked &#x27;Premier Exchange Properties&#x27; targeting stable cash flow. Sits within a ~$19 billion Bluerock platform that also runs interval funds. Sources institutional-quality assets across sectors and a national footprint. Operates across full market cycles, lending uncommon seasoning.
Current coverage
4 current offerings are linked from this profile. Availability, projected income, leverage, and documents can change, so investors should confirm the current version of each PPM and related supplement before relying on any figure. The page includes 131 full-cycle records in the current workbook. Those figures are sponsor-reported and unaudited; they are shown to make the source and scope visible, not to imply that a future offering will repeat historical results.
