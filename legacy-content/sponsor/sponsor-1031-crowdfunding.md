---
url: https://baker1031.com/sponsor-1031-crowdfunding.html
slug: sponsor-1031-crowdfunding
title: "1031 Crowdfunding"
category: sponsor
words: 689
---

1031 Crowdfunding | Baker 1031 Investments
Home ❯ Sponsors ❯ 1031 Crowdfunding
1031 Crowdfunding
On This Page
Sponsor Facts
Overview
...
Equity Multiple
Annual Return
How to Read This Sponsor Profile
This page is a Baker 1031 Investments research summary for 1031 Crowdfunding. The workbook currently records a reported founding year of 2014, reported assets under management of $2.8B, a reported headquarters in Irvine, CA. Baker 1031 presents these fields to help an accredited investor organize due-diligence questions; the page is not a sponsor endorsement, performance guarantee, or individualized investment recommendation.
...
What the strategy fields mean The strategy and advantage fields are a compact description of how 1031 Crowdfunding presents its approach. They are not a recommendation, rating, or substitute for the PPM. Compare them with property-level leverage, tenant concentration, reserves, fees, exit assumptions, and the investor rights described in the offering documents. Earliest mover among online 1031 marketplaces, a digital-distribution edge that reaches self-directed exchangers at scale rather than through the traditional broker-dealer channel. Runs a proprietary investor-facing technology platform that compresses search, suitability and subscription into one online workflow. Tilts its curated shelf toward senior-housing and medical assets, a needs-based product bias rather than a generic DST menu. Sponsors its own in-house non-traded REIT, capturing economics across the value chain rather than acting purely as a conduit. Markets unusually low minimums, widening the accredited-investor funnel versus higher-entry competitors.
Current coverage
No current offerings are linked from this profile in the workbook snapshot. The directory can change as new offerings are reviewed. No full-cycle rows are currently present in the workbook for this sponsor. That absence is a data-coverage limitation, not evidence about performance.
...
Understand Delaware Statutory Trusts
How we evaluate DST sponsors
