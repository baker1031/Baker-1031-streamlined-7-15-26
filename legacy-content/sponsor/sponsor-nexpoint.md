---
url: https://baker1031.com/sponsor-nexpoint.html
slug: sponsor-nexpoint
title: "NexPoint"
category: sponsor
words: 678
---

NexPoint | Baker 1031 Investments
Home ❯ Sponsors ❯ NexPoint
NexPoint
On This Page
Sponsor Facts
Overview
...
This page is a Baker 1031 Investments research summary for NexPoint. The workbook currently records a reported founding year of 2012, reported assets under management of $15.0B, a reported headquarters in Dallas, TX. Baker 1031 presents these fields to help an accredited investor organize due-diligence questions; the page is not a sponsor endorsement, performance guarantee, or individualized investment recommendation.
...
What the strategy fields mean The strategy and advantage fields are a compact description of how NexPoint presents its approach. They are not a recommendation, rating, or substitute for the PPM. Compare them with property-level leverage, tenant concentration, reserves, fees, exit assumptions, and the investor rights described in the offering documents. Operates a ~$15 billion alternatives platform spanning listed/non-listed REITs, DSTs, interval funds and a BDC. Offers a broad 1031/DST and closed-end product suite under one roof. Combines real estate and credit capabilities (affiliate of the former Highland Capital complex). Co-invests significant own capital alongside investors. Concentrates conviction positions in its Dallas/Uptown home market.
Current coverage
6 current offerings are linked from this profile. Availability, projected income, leverage, and documents can change, so investors should confirm the current version of each PPM and related supplement before relying on any figure. The page includes 3 full-cycle records in the current workbook. Those figures are sponsor-reported and unaudited; they are shown to make the source and scope visible, not to imply that a future offering will repeat historical results.
