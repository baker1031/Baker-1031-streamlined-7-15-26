---
url: https://baker1031.com/dst-guide.html
slug: dst-guide
title: "Delaware Statutory Trusts: 2026 Guide"
category: guide
words: 3972
---

Delaware Statutory Trusts: 2026 Guide | Baker 1031
Home ❯ Insights ❯ Delaware Statutory Trusts: The 2026 Definitive Guide
Delaware Statutory Trusts: The 2026 Definitive Guide
Back to All Insights
Definitive Guide · 2026 Gerald F. "Jerry" Baker, III · Updated June 2026 · 32 min read
...
03 · How a DST Works Under the Hood
...
Cash held conservatively: reserves can only sit in short-term, high-quality instruments such as government securities or money-market funds, as permitted by the trust agreement.
...
Tax deferral today, with the potential for heirs to receive a stepped-up basis that may eliminate the deferred gain, though step-up rules can change and outcomes depend on your circumstances.
Truly passive — the sponsor takes the 2 a.m. maintenance call, and your only recurring task is depositing the distribution.
...
A potential backup option for a 1031 exchange that's about to fail, though subscription acceptance, suitability review, and offering availability are never assured.
...
Exhibit — Baker 1031 sector yield benchmarks, as of Q2 2026. Figures are drawn from Baker 1031's review of active and recently offered DST programs by sector and represent projected current-distribution rates, not realized returns. Projected distribution rates are not guaranteed and may be reduced or suspended. A projected distribution far above its sector average deserves scrutiny, not excitement.
Interactive Is this DST right for me?
...
0 /8
Start checking boxes Your fit score updates live.
...
Sponsors tracked 82
Preferred 8
With track record 21
No record yet 61
Benchmark · all sponsors Return 14.9% MOIC 1.46x Hold 4.7 yr Win 96.5%
★ Benchmark · preferred cohort Return 20.8% MOIC 1.53x Hold 3.6 yr Win 98.1%
...
Answer five questions. The tool weighs your priorities across the three exit paths and explains the trade-off you'd be accepting. This is an educational illustration, not a recommendation: it does not consider your full financial situation, its criteria are limited to the inputs you provide, and its results are not guaranteed. Use it as a starting point to discuss with your advisor.
See my illustrative path
Reset
Illustrative path to discuss with your advisor
...
Number of DSTs 4
Equity per DST $250,000
Typical minimum $25k–$100k
Diversification —
Future single-property exchange flexibility —
13 · Frequently Asked Questions
Can I get my money out of a DST early? Generally no. DST interests aren't publicly traded and secondary sales are rare and often at a discount. Plan to stay invested for the full 5-to-10-year hold; treat the capital as locked up.
Who can invest in a DST? DSTs are private placements limited to accredited investors — generally a net worth above $1 million excluding your primary home, or income above $200,000 ($300,000 jointly) in each of the last two years.
What return should I expect? It varies widely by sponsor, sector, and leverage. Our platform data shows average annual returns clustering in the high single digits to low twenties for sponsors with completed deals — but past results are not a guarantee, and headline projections deserve scrutiny against sector benchmarks.
What happens if the sponsor runs into trouble? Your outcome is tied to the property and the operator. A troubled deal can cut or suspend distributions, and the springing-LLC provision exists precisely to let a manager act in a crisis — at the cost of that interest's 1031 status. This is why sponsor review and diversification matter.
Can I 1031 out of a DST when it sells? Yes. At the full-cycle sale you can take the cash (and pay deferred tax), exchange into another 1031/DST to keep deferring, or — if offered — convert into REIT units via a 721 exchange. The exit quiz above helps you decide which.
14 · Glossary
Beneficial Interest Your fractional ownership stake in the trust — treated as direct real-property ownership for 1031 purposes.
Boot Sale value or debt not replaced in an exchange. Boot is taxable and reduces the deferral.
Equal-or-Up Rule To fully defer, the replacement must match or exceed the relinquished property's price and debt.
Full-Cycle Deal A deal carried from acquisition through final sale — the only metric that proves realized results.
MOIC / Equity Multiple Total dollars returned per dollar invested; 1.5x means $1 became $1.50 over the hold.
Qualified Intermediary (QI) The independent party that holds sale proceeds so the investor avoids constructive receipt.
Revenue Ruling 2004-86 The IRS guidance that lets DST beneficial interests qualify as 1031 replacement property.
Springing LLC A provision letting a distressed DST convert to an LLC to act — forfeiting 1031 status on that interest.
721 / UPREIT Exchange Contributing property (often via a DST) into a REIT's operating partnership for OP units, deferring gain.
Explore the DST strategy
This guide anchors our Delaware Statutory Trust library. Go deeper on how DSTs work, what to look for in a sponsor, the returns and fees you actually keep, and how to weigh a DST against the alternatives:
...
How to Review a PPM: A Deep Dive for Accredited Investors
...
DST vs. TIC: Comparing 1031 Co-Ownership Structures
Who Can Invest in a DST? Accredited Investor Rules
15 · Sources & References
Performance, full-cycle, and sponsor track-record figures referenced in this guide and in the Sponsor Explorer come from Baker 1031's Data Center — our proprietary dataset of realized, full-cycle DST deals and sponsor histories. Past performance is not indicative of future results.
IRS, Rev. Rul. 2004-86 — a Delaware Statutory Trust beneficial interest is treated as a direct interest in real property eligible for a §1031 like-kind exchange.
Internal Revenue Code, 26 U.S.C. §1031 — exchange of real property held for productive use or investment (incl. the 45/180-day rules at §1031(a)(3)).
Internal Revenue Code, 26 U.S.C. §721 — nonrecognition on the contribution of property to a partnership (the basis of a 721/UPREIT conversion).
SEC, 17 CFR §230.501 (Rule 501 of Regulation D) — the accredited-investor definition that governs who may invest in a DST.
16 · Disclosures
...
B
Gerald F. "Jerry" Baker, III
1031 & Securitized Real Estate Desk
Gerald F. "Jerry" Baker, III maintains proprietary coverage of DST sponsors, offerings, and full-cycle performance to help exchangers evaluate replacement options with the same rigor applied to direct acquisitions.
